...
plasma_freq = np.array([ 0,    1,  2,  3, 3.5,   4,   5,   6,   7,  7.3])
height      = np.array([95, 95.5, 96, 99, 103, 117, 160, 215, 268,  280])
...
fE = 3.7e6
nE = fp2_to_ne(fE**2)
yE = 1.08e5 - 9.41e4 #KM --- half thickness of the parabolic profile | put by hand
zE = 1.08e5 #KM --- height of the E layer peak
